                                ...
                                <div className="product_preview_gallery">
                                  {
                                    ...
                                    <Slider {...settings}>
                                      <div>
                                        <img onClick={() => handleChangePreviewImg(previewImg)} src={previewImg} className="multiple_preview_images pointer" alt="" />
                                      </div>
                                      {
                                        product.images.map((item, index) => (
                                          <div key={index + 1} >
                                            <img onClick={() => handleChangePreviewImg(item.image_url)} src={item.image_url} className="multiple_preview_images pointer" alt="" />
                                          </div>
                                        ))
                                      }
                                    </Slider>
